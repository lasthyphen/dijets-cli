...
import (
	...
	"github.com/lasthyphen/dijets-cli/internal/mocks"
...
func TestGetGithubLatestReleaseURL(t *testing.T) {
	...
	expected := "https://api.github.com/repos/lasthyphen/dijetsnode/releases/latest"
	...
	tests := []urlTest{
		{
			...
			goarch:      "amd64",
			goos:        "linux",
			expectedURL: "https://github.com/lasthyphen/dijetsnode/releases/download/v1.17.1/dijetsnode-linux-amd64-v1.17.1.tar.gz",
		...
		},
		{
			...
			goarch:      "arm64",
			goos:        "darwin",
			expectedURL: "https://github.com/lasthyphen/dijetsnode/releases/download/v1.18.5/dijetsnode-macos-v1.18.5.zip",
		...
		},
		{
			...
			goarch:      "amd64",
			goos:        "windows",
			expectedURL: "https://github.com/lasthyphen/dijetsnode/releases/download/v2.1.4/dijetsnode-win-v2.1.4-experimental.zip",
			expectedExt: zipExtension,
			expectedErr: nil,
		},
		{
	...
	tests := []urlTest{
		{
			...
			goarch:      "amd64",
			goos:        "linux",
			expectedURL: "https://github.com/lasthyphen/subnet-evm/releases/download/v1.17.1/subnet-evm_1.17.1_linux_amd64.tar.gz",
			expectedExt: tarExtension,
			expectedErr: nil,
		},
		{
			...
			goarch:      "arm64",
			goos:        "darwin",
			expectedURL: "https://github.com/lasthyphen/subnet-evm/releases/download/v1.18.5/subnet-evm_1.18.5_darwin_arm64.tar.gz",
			expectedExt: tarExtension,
			expectedErr: nil,
		},
		{
