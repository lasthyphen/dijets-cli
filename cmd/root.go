...
import (
	...
	"github.com/lasthyphen/dijets-cli/cmd/backendcmd"
	"github.com/lasthyphen/dijets-cli/cmd/keycmd"
	"github.com/lasthyphen/dijets-cli/cmd/networkcmd"
	"github.com/lasthyphen/dijets-cli/cmd/subnetcmd"
	"github.com/lasthyphen/dijets-cli/cmd/transactioncmd"
	"github.com/lasthyphen/dijets-cli/internal/migrations"
	"github.com/lasthyphen/dijets-cli/pkg/apmintegration"
	"github.com/lasthyphen/dijets-cli/pkg/application"
	"github.com/lasthyphen/dijets-cli/pkg/config"
...
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use: "dijets",
		Long: `Dijets-CLI is a command-line tool that gives developers access to
...
in with dijets subnet create myNewSubnet.`,
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.dijets-cli.json)")
