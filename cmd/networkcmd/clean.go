...
configuration.`,
	...
	cmd.Flags().BoolVar(
		...
		"hard",
		false,
		"Also clean downloaded dijetsnode and plugin binaries",
	)
...
func clean(*cobra.Command, []string) error {
	...
	if hard {
		ux.Logger.PrintToUser("hard clean requested via flag, removing all downloaded dijetsnode and plugin binaries")
