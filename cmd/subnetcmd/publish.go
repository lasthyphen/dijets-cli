...
func getVMInfo(sc *models.Sidecar) (*types.VM, error) {
	...
	case sc.VM == models.SubnetEvm:
		...
		desc = "Subnet EVM is a simplified version of the Utility Chain VM. It implements the Ethereum Virtual Machine and supports Solidity smart contracts as well as most other Ethereum client functionality"
		maintrs, ver, url, sha, err = getInfoForKnownVMs(
			sc.VMVersion,
