...
import (
	...
	ANRclient "github.com/lasthyphen/dijets-network-runner/client"
...
func applyLocalNetworkUpgrade(subnetName string, sc models.Sidecar) error {
	...
	if err != nil {
		if err == os.ErrNotExist {
			...
			ux.Logger.PrintToUser("You may need to first create it with the `dijets subnet upgrade generate` command or import it")
