...
import (
	...
	"github.com/lasthyphen/dijets-cli/tests/e2e/commands"
	"github.com/lasthyphen/dijets-cli/tests/e2e/utils"
...
var _ = ginkgo.Describe("[APM]", func() {
	ginkgo.BeforeEach(func() {
		...
		// More details: https://github.com/lasthyphen/dijets-cli/issues/244
		utils.RemoveAPMRepo()
	})
	...
	ginkgo.It("can import from dijets-core", func() {
		repo := "lasthyphen/dijets-plugins-core"
